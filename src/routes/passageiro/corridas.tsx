      ...
      <div className="space-y-3">
        {filteredRides.length > 0 ? (
          filteredRides.map((ride) => {
            ...
            const CardContent = (
              <div className="p-4 bg-white border border-slate-100 rounded-[24px] hover:border-navy/10 transition-all active:scale-[0.98]">
                ...
                <div className="relative pl-4 border-l-2 border-slate-50 space-y-3 ml-2">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-xs font-semibold text-navy truncate">
                      {getRegion(ride.destination?.address)}
                    </p>
                  </div>
                </div>
          ...
          <div className="py-20 text-center bg-white border border-dashed border-slate-200 rounded-[32px]">
            ...
            <p className="text-xs text-slate-400 mt-1 px-10">
              Tente ajustar seus filtros ou busca nesta demonstração.
            </p>
          </div>
        )}
      </div>
