  ...
  if (step === 'success') {
    return (
      <div className="flex min-h-screen flex-col bg-white p-6 items-center text-center justify-center animate-in fade-in duration-500">
        ...
        <h1 className="text-2xl font-black italic uppercase tracking-tighter text-navy mb-4">Simulação concluída</h1>
        <p className="text-slate-500 text-sm leading-relaxed mb-8 max-w-[280px]">
          Esta é uma demonstração. Geramos o identificador simulado <span className="text-navy font-bold">PR-DEMO-001</span>. Nenhuma denúncia real foi registrada.
        </p>
  ...
  return (
    <div className="flex min-h-screen flex-col bg-porcelain font-sans text-navy">
      <header className="bg-white px-6 py-6 border-b border-slate-100 flex items-center gap-4">
        <button 
          type="button"
          onClick={() => step === 'details' ? setStep('category') : navigate({ to: `/passageiro/corrida/${rideId}/em-andamento` })}
          ...
          aria-label={step === 'details' ? "Voltar para seleção de categoria" : "Voltar para a corrida"}
        >
      ...
      <main className="flex-1 p-6 overflow-y-auto">
        ...
        {step === 'category' ? (
          <div className="space-y-4">
            ...
            <h2 className="text-[10px] font-black uppercase tracking-[0.15em] text-slate-400 px-2">Selecione uma categoria (Simulado)</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="block text-[10px] font-black uppercase tracking-widest text-slate-400">Categoria selecionada</span>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="text-[10px] font-bold text-slate-400 uppercase">Foto ou Vídeo (Simulado)</span>
                </button>
                {hasEvidence && (
                  <div className="flex items-center gap-2 p-2 bg-blue-50 border border-blue-100 rounded-xl">
                    ...
                    <span className="text-[10px] font-bold text-blue-600 uppercase">Evidência simulada (não armazenada)</span>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="p-4 bg-blue-50 rounded-2xl border border-blue-100 flex gap-3">
              ...
              <p className="text-[10px] text-blue-800 font-medium leading-relaxed italic">
                Nota: Esta interface demonstra como relatos seriam tratados. Nesta versão local, nada é enviado.
              </p>
            </div>
