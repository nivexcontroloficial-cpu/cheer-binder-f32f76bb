...
function RideCompletedScreen() {
  ...
  const search = useSearch({ from: "/passageiro/corrida/$rideId/concluida" });
  ...
  return (
    <main className="flex min-h-screen flex-col bg-porcelain font-sans text-navy pb-10">
      ...
      <div className="bg-navy pt-16 pb-12 px-8 rounded-b-[48px] text-white flex flex-col items-center text-center shadow-2xl relative overflow-hidden">
        ...
        <h2 className="text-3xl font-black italic tracking-tighter uppercase mb-2">Chegamos!</h2>
        ...
        <div className="bg-white rounded-[32px] p-8 shadow-xl border border-slate-100 flex flex-col items-center">
          ...
          <div className="w-full space-y-6">
            ...
            <textarea
              ...
              className="w-full min-h-[100px] bg-slate-50 border border-slate-100 rounded-2xl p-4 text-xs font-medium focus:ring-navy focus:border-navy"
            />
          </div>
        </div>
