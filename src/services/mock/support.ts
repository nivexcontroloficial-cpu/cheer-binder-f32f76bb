...
export const MOCK_PROTOCOLS: SupportProtocol[] = [
  {
    ...
    timeline: [
      { id: 'e1', status: 'nova', message: 'Denúncia recebida pelo sistema.', timestamp: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString() },
      { id: 'e2', status: 'em_triagem', message: 'Caso encaminhado para equipe de conformidade.', timestamp: new Date(Date.now() - 4.5 * 24 * 60 * 60 * 1000).toISOString() },
      { id: 'e3', status: 'resolvida', message: 'O piloto foi advertido e a ocorrência registrada em seu perfil.', timestamp: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString() },
    ]
  },
  {
    id: 'PR-2026-002',
    ...
    timeline: [
      { id: 'e1', status: 'nova', message: 'Denúncia recebida.', timestamp: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
      { id: 'e2', status: 'em_triagem', message: 'Analisando telemetria da corrida.', timestamp: new Date(Date.now() - 0.5 * 24 * 60 * 60 * 1000).toISOString() },
    ]
  }
];
